...
class ProcessThreading(multiprocessing.Process):
    pause_method = THREAD_PAUSE_SET_FLAG_ONLY
    ...
    def __force_terminate(self):
        ...
        raise ThreadTerminated(
            t2t('If you see this error, it\'s just because the thread was terminated normally, not a fatal error.'))
