...
class Button(ImgIcon):
    def __init__(self, path, button = None, name=None, black_offset=10):
        self.path = path
        ...
        super().__init__(name=name, path=self.path, is_bbg = True, bbg_posi = bbg_posi, jpgmode = 0, threshold=0.85)
