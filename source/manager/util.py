...
from source.exceptions.common import SearchImagePathError
...
class AssetBase():
    def __init__(self, name: str, print_log:int = LOG_WHEN_TRUE) -> None:
        if name is None:
    ...
    def search_path(self, filename) -> str:
        for comp_filename in [filename + '.png', filename + '.jpg']:
            ...
            raise SearchImagePathError(comp_filename)
