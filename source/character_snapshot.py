...
while(1):
    ...
    print('color: ')
    for i in range(4):
        cv2.imwrite('outputimgs/characterlist_'+str(i)+'.png',cap[posi_chara_list[i][0]:posi_chara_list[i][2],posi_chara_list[i][1]:posi_chara_list[i][3]])
        cv2.imwrite('outputimgs/character_listq_'+str(i)+'.png',cap[posi_charalist_q[i][0]:posi_charalist_q[i][2],posi_charalist_q[i][1]:posi_charalist_q[i][3]])
