...
class ImgIcon():
    def __init__(self, name, path, is_bbg=True, matching_rate=None, alpha=None, bbg_posi=None, cap_posi=[1080,1920], jpgmode=2, threshold=0.95):
        self.name=name
        self.path=path
        self.is_bbg=is_bbg
...
USE_20RESIN_DOBLE_CHOICES=ImgIcon(name="USE_20RESIN_DOBLE_CHOICES", path="assests\\imgs\\common\\USE_20RESIN_DOBLE_CHOICES.jpg",
                                       is_bbg=True, bbg_posi=[724, 985, 791, 1348], cap_posi='bbg')
USE_20X2RESIN_DOBLE_CHOICES=ImgIcon(name="USE_20X2RESIN_DOBLE_CHOICES", path="assests\\imgs\\common\\USE_20X2RESIN_DOBLE_CHOICES.jpg",
