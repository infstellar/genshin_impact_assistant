...
class ImpregnableDefense_P2103N3138(Commission):
    def __init__(self):
        super().__init__("ImpregnableDefense", [2103,-3138], is_CFCF=True, is_TMCF=True)

    def exec_mission(self):
        r = self.move_straight(position=[2103,-3138], is_tp=True)
