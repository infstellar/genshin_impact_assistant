...
def get_all_collection_name()->list:
    ...
    # print()
    black_list = ['狂风，听谁号令', '听海人', '手鞠游戏', '突发委托', '相位之门', '石碑', '键纹基座Ⅰ'] # 这是排除列表，将不属于可采集物的加进去。正在添加中...
    """全列表如下：(version: v0.3.0.331)

    ['', '狂风，听谁号令', '听海人', '手鞠游戏', '突发委托', '雷神瞳2', '兽肉 - 稻妻', '相位之门', '石碑', '深海龙蜥 - 渊下宫', '键纹基座Ⅰ', '禽肉 - 稻妻', '史莱姆 - 蒙德', '雪山迷踪
', '鱼肉 - 蒙德', '摩拉调查点 - 稻妻', '武器调查点 - 鹤观', '愚人众先遣队 - 璃月', '【「清籁岛」的记录画片 · 之二】对应拍照点', '史莱姆 - 鹤观', '盗宝团 - 璃月', '发光髓-群岛', '「无名小岛」的壁画', '止水之潘', '深渊法师 - 稻妻', '天遒宝迹', '水晶矿 - 群岛', '传送锚点 - 稻妻 - 鹤观', '海上拾玉', '雾海纪行 - 要求特别多的作家', '苹果 - 稻妻', '史莱姆 - 群 
...
护身符 【伊部】', '等量交换', '丘丘人 - 蒙德', '骗骗花 - 海岛', '木匣 - 稻妻', '螃蟹 - 璃月', '遗迹机兵 - 鹤观', '工作迫近', '圣遗物调查点 - 稻妻2', '地理志-蒙德', '电气水晶-群岛
', '此诗送此城', '雪山大勘探', '胡萝卜 - 稻妻', '宝箱 - 蒙德', '旧味难寻', '低温调查', '传送锚点 - 璃月 - 云来海', '兽肉 - 海岛', '堇瓜 - 稻妻', '妖狸 - 稻妻', 'NPC商店 - 蒙德', 
'大生意', '水泡泡', '禽肉 - 蒙德', '塞西莉亚苗圃', '紫晶矿 - 稻妻', '白萝卜-群岛', '夜叉之愿', '砂流之庭', '清籁旧宝', '书籍 - 稻妻2', '蝴蝶翅膀 - 稻妻2', '【第一章 第四幕 · 报幕
】戴因斯雷布', '门户清理', '树莓 - 蒙德', '蒙德宝箱', '藏宝图【岻伽】', '酒庄大扫除', '薄荷 - 璃月', '传送锚点 - 蒙德 - 明冠山地', '铁矿 - 鹤观', '收集风之印的少女', '甜甜花 - 稻
妻', '鸣草 - 稻妻', '公主之匣', '遗迹机兵 - 渊下宫', '松茸 - 蒙德', '深入风龙废墟', '大型丘丘人 - 璃月', '钓鱼点 - 蒙德', '无妄引咎密宫「祝圣秘境：寒霜」', '债务处理人 - 蒙德', '海渊仙草灵验记', '厄瑞玻斯的秘密 - 岐之试炼', '安提戈努斯', '借景之馆', '慕风蘑菇', '密室大门', '愚人众 - 萤术士 - 璃月', '冰雾花 - 群岛', '精华拜受处', '史莱姆 - 稻妻2', '回声海
螺', '「双双岛」的壁画', '电气水晶 - 璃月', '塞西莉亚花', '甜甜花 - 蒙德', '蘑菇 - 璃月', '苹果 - 蒙德', '盗宝团 - 蒙德', '遗迹猎者 - 璃月', '风暴后遗症', '白铁矿 - 稻妻', '鱼肉 
...
稻妻', '鸟蛋 - 蒙德', '食材调查点 - 稻妻2', '白萝卜 - 璃月', '鸣神寻踪', '螃蟹 - 稻妻2', '白铁矿 - 群岛', '食莲者', '摆设图纸 - 稻妻', '欢迎来到冒险家协会', '食谱 - 稻妻', '记事 
者之匣', '千里之信', '兽境猎犬 - 鹤观', '七天神像-风', '烈焰花 - 蒙德', '北风之狼的庙宇', '观景点 - 鹤观', '嘟嘟莲', '摆设图纸NPC-蒙德', '松树 - 松木 - 稻妻', '白萝卜 - 稻妻', ' 
丘丘暴徒 - 璃月', '薄荷 - 蒙德', '大伟丘', '【木户】与【木奈】 - 鹤观', '琉璃袋', '祭祀之匣', '笋 - 璃月', '胡萝卜 - 璃月', '蜥蜴尾巴 - 群岛', '丘丘人射手 - 群岛', '清籁逐雷记 · 
...
箱 - 渊下宫', '蝴蝶翅膀 - 蒙德', '书抵万金', '白夜国晨昏记-常世入口', '全能美食队 · 寻食之旅', '马尾 - 璃月', '债务处理人 - 稻妻', '七天神像-岩', '地理志-璃月', '许伯利翁哀歌-狭 
间的叩问', '白铁矿 - 璃月', '琉璃百合', '血斛 - 稻妻', '甜甜花 - 璃月', '深渊法师-群岛', '璃月宝箱', 'NPC奖励 - 蒙德', '宝箱 - 鹤观', '壁画', '松果 - 璃月', '远吕羽氏遗事 · 序', 
'鱼肉 -稻妻2', '梦里生花', '小灯草', '书籍-璃月', '冷鲜肉 - 蒙德', '蛇骨矿洞 · 磐柱镇石', '白铁矿 - 渊下宫', '险恶的教喻', '传送锚点 - 蒙德 - 堕星山谷', '冰雾花 - 蒙德', '观景点 
...
岛 双双岛', '冰雾花', '射手丘丘人 - 鹤观', '风晶蝶 - 蒙德', '白铁矿 - 鹤观', '晶核 - 蒙德', '薄荷 - 鹤观', '青蛙 - 璃月', '独木难支', '海贼的标记', '松果 - 鹤观', '蜥蜴尾巴 - 蒙 
...
碑', '重岩之意', '丘丘王 - 璃月', '传送锚点「蒙德  风啸山坡」 ', '孤岛诊疗谭', '晶核 - 稻妻2', '浪船锚点 - 群岛 双双岛', '键纹Ⅰ', '白夜国晨昏记-缝隙间的梦', '磨刀不误砍柴工', '某
...
髓 - 鹤观', '泡泡', '必要手续', '鸣神岛 · 天守', '螃蟹 - 蒙德', ' - 蒙德', '紫晶矿 - 鹤观', '渌华景画', '萤术士  - 稻妻', '松茸 - 稻妻', '全能美食队 · 深潜者', '刀剑成梦', '圣遗 
...
'诸国游记', '兽肉 - 璃月', '白萝卜 - 蒙德', '风后宝矿', '却砂木', '三色档案', '异国的披萨', '矿物调查 - 璃月', '海灵芝', '石匣 - 渊下宫', '金鱼草 - 璃月', '兽肉 - 鹤观', '蜥蜴尾 
...
玉壶 · 其一/ 翠石砌玉壶 · 其二', '藏镜仕女 - 稻妻', '华池岩岫「祝圣秘境：岩牢」', '栽种之法', '七神的赐福', '尾声，风停之后', '进入「黄金屋」', '远吕羽氏遗事 · 其一', '奇异的牙齿 妻 - 神无冢', '萤火虫 - 璃月', '笔迹已经模糊的笔记', '丘丘人 - 鹤观
 - 龙脊雪山', '绯红玉髓', '书籍 - 蒙德', '松果 - 蒙德', '传送点 - 稻妻 - 神无冢', '萤火虫 - 璃月', '笔迹已经模糊的笔记', '丘丘人 - 鹤观', '骗骗花 - 璃月', '盗宝鼬 - 璃月', '浪船  ', '「伏龙树」之底', '丘丘人 - 稻妻', '魔晶矿 - 稻妻2', '羽扇枫-枫 
锚点', '遗迹守卫 - 蒙德', '冰雾花 - 璃月', '羽毛', '许伯利翁哀歌-庙前的叩问\t', '玄月宝箱', '电气水晶 - 稻妻', '烈焰花 - 群岛', '蒲公英籽', '「伏龙树」之底', '丘丘人 - 稻妻', '魔, '键纹基座Ⅴ', '覆雪之国', '晶核 - 渊下宫', '[八重堂」的邀约', '循仙
...
萨满 - 璃月', '宝藏归离', '传送锚点「蒙德  明冠山地」', '无明岩 · 磐柱镶珠', '古云有「螭」', '食材调查点 - 蒙德', '遗迹重机 - 蒙德', '传送锚点「蒙德  堕星山谷」 ', '太山府「精通 '璃月幼岩龙蜥', '食谱 - 龙脊雪山', '树莓 - 璃月', '武器调查点 - 稻妻
...
的记录画片 · 之三】对应拍照点', '传送锚点「蒙德  苍风高地」 ', '鸟蛋 - 海岛', '岩龙蜥 - 璃月', '腐殖之牙', '钩钩果', '璃月幼岩龙蜥', '食谱 - 龙脊雪山', '树莓 - 璃月', '武器调查点
