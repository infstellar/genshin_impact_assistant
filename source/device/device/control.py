...
from source.device.method.maatouch import MaaTouch
from source.device.method.minitouch import Minitouch
from source.device.method.uiautomator_2 import Uiautomator2
from source.util import logger


class Control(Adb, Uiautomator2, Minitouch, MaaTouch):
